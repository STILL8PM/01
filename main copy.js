...
//Instantiate object 实例对象
const person1 = new Person('Jhon', 'Doe', '4-3-1980');
const person2 = new Person('Mary', 'Smith', '3-6-1970');
//console.log(person1);//输出person1
//console.log(person2.dob.getFullYear());//输出person2的年份
//console.log (person1.getBirthYear());//输出1980
//console.log (person1.getFullName());//输出全名
//console.log (person1);
